...
@Component({
  ...
  template: `
    <div class="relative flex justify-center items-center">
      ...
      <!-- Projects Card -->
      <div
        class="absolute -left-4 top-12 sm:-left-6 sm:top-16 lg:-left-8 lg:top-20 bg-background border border-primary/20 rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4 shadow-lg backdrop-blur-sm min-w-[60px] sm:min-w-[70px] lg:min-w-[80px]"
      >
      ...
      <!-- Experience Card -->
      <div
        class="absolute -right-4 bottom-12 sm:-right-6 sm:bottom-16 lg:-right-8 lg:bottom-20 bg-background border border-secondary/20 rounded-lg sm:rounded-xl p-2 sm:p-3 lg:p-4 shadow-lg backdrop-blur-sm min-w-[60px] sm:min-w-[70px] lg:min-w-[80px]"
      >
