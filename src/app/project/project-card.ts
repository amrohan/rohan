  ...
  template: `
    <div
      ...
      <a [href]="project().githubUrl">
        ...
        <p class="text-subtle  line-clamp-5 mt-3 hover:text-shadow-neutral-800 dark:hover:text-shadow-neutral-50 hover:opacity-90">{{ project().description }}</p>
      </a>
      <div class="flex justify-end items-center gap-6 h-16 w-full" [class.!justify-between]="project().downloadCount">
        @if (project().downloadCount) {
          <a title="Download Count" [href]="project().packageUrl"
