...
- **Live Demo**: [Devnews](https://devnews.gq/)
- **Backend Code**: [Backend of Devnews](https://github.com/amrohan/DevNews-Backend)
- **Telegram Bot Code**: [Telegram Bot Code](https://github.com/amrohan/Dev-News-Bot)
...
1. **Sign Up**: First, visit the Devnews website and sign up for an account to begin using the Telegram bot.
2. **Start the Bot**: Open the Devnews bot on Telegram and start interacting by typing a command to receive tech news updates.
3. **Customize Your Feed**: Tailor the types of tech news you want to receive based on your interests, such as gadgets, software, or AI.
4. **Stay Updated**: The bot will send you the latest headlines and articles directly to your chat, keeping you up to date with the tech world.
